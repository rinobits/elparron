 ...
 * returns createTrue
 **/
exports.createSemanal = function(body,fecha,sucursal_id) {
 ...
 * returns modifyTrue
 **/
exports.editSemanal = function(body,fecha,sucursal_id) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = {
  "MODIFY DATA" : true
 ...
 * returns getJsonData
 **/
exports.getSemanalById = function(fecha,sucursal_id) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = {
  "sucursal_id" : 1,
